document.addEventListener("DOMContentLoaded", () => {
    ...
    minimizeChat.addEventListener("click", () => {
      if (chatBody.style.display === "none") {
        ...
        minimizeChat.textContent = "−"; // Ubah ikon ke minimize
      } else {
        chatBody.style.display = "none";
        chatFooter.style.display = "none";
        minimizeChat.textContent = "+"; // Ubah ikon ke maximize
      }
    });
    ...
    sendMessage.addEventListener("click", () => {
      ...
      if (userMessage !== "") {
        ...
        setTimeout(() => addMessage("Bot", botResponse), 500); // Respon dengan jeda
    ...
    const addMessage = (sender, message) => {
      ...
      chatBody.scrollTop = chatBody.scrollHeight; // Scroll otomatis ke bawah
    };
  
    // Daftar kata kunci dan sinonim untuk pencocokan input
    const keywords = {
      ...
      keunggulan: ["keunggulan", "kelebihan", "kenapa memilih", "mengapa memilih", "produk", "sabun"],
